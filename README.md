# Deepseek Electron Wrapper for Windows


## 🚀 Features

This desktop client transforms the web interface into a native, high-performance Windows experience with deep OS integration:

*   **⚡ Instant Toggle Hotkey:** Press `Ctrl + Shift + Space` anywhere on your PC to hide or show the DeepSeek window.
*   **📥 System Tray Minimize:** Closing the app window keeps it alive in the taskbar.
